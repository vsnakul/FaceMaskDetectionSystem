        ...
        while True:
            ...
            for (box, pred) in zip(locs, preds):
                ...
                if mask>withoutMask:
                    ...
                    #sheet = book.active
                    cellValue=self.sheet['A1']
                    counter=int(cellValue.value)
                    counter+=1
                    self.sheet['A1']=counter
                    self.book.save('dummy_db.xlsx')
                    print("value for the counter is ",counter)

                else:
                    label="No Mask"
                    color=(0,0,255)
                    self.book = openpyxl.load_workbook('dummy_db.xlsx')
                    self.sheet['A1']=0
                    self.book.save('dummy_db.xlsx')
